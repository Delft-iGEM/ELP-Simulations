...
nx, ny = 4, 4
# spacing = 1/sqrt(0.015 chains/nm^2)
spacing = 8.165
...
# lysine pairs within 0.8 nm (8.0 A) bond during the run, valence 1, p=0.1
crosslink = {'distance': 0.8, 'valence': 1, 'prob': 0.1, 'check_every': 1000, 'k': 2000.0, 'r0': 0.6, 'ramp_steps': 500, 'selection': None, 'start_step': 1000000, 'seed': None, 'min_span': 3}
...
# preattached: lysines within 0.8 nm (8.0 A) of the tether plane bond to it; bound lysines sit 0.6 nm above the wall; cap 0.5 of all lysines; 0.4 bound at t=0
mode = "preattached"
surface = {'mode': 'preattached', 'distance': 0.8, 'prob': 1.0, 'max_fraction': 0.5, 'preattached_fraction': 0.4, 'dynamic': None, 'k': 2000.0, 'tether': 0.6, 'ramp_steps': 500, 'check_every': 1000, 'start_step': 1000000, 'attraction': 0.0, 'attraction_width': 0.5, 'seed': 1535175710, 'z_wall': 1.9}
...
sequences: dict[str, str] = {
     "triblock-64-pre-xl-v3": ""
}
if mode == "brush":
     ...
     sequences["triblock-64-pre-xl-v3"] = f"Z{sequences['triblock-64-pre-xl-v3'][1:]}"
