...
nx, ny = 4, 4
# spacing = 1/sqrt(0.020827 chains/nm^2)
spacing = 6.929
...
mode = "preattached"
surface = {'mode': 'preattached', 'distance': 0.8, 'prob': 1.0, 'max_fraction': 0.5, 'preattached_fraction': 0.2, 'dynamic': None, 'k': 2000.0, 'tether': 0.6, 'ramp_steps': 500, 'check_every': 1000, 'start_step': 1000000, 'attraction': 0.0, 'attraction_width': 0.5, 'seed': 1948508484, 'z_wall': 1.9}
...
sequences: dict[str, str] = {
     "triblock-32-pre-noxl-mm025-f20": ""
}
if mode == "brush":
     ...
     sequences["triblock-32-pre-noxl-mm025-f20"] = f"Z{sequences['triblock-32-pre-noxl-mm025-f20'][1:]}"
