...
mode = "preattached"
surface = {'mode': 'preattached', 'distance': 0.8, 'prob': 1.0, 'max_fraction': 0.5, 'preattached_fraction': 0.4, 'dynamic': None, 'k': 2000.0, 'tether': 0.6, 'ramp_steps': 500, 'check_every': 1000, 'start_step': 1000000, 'attraction': 0.0, 'attraction_width': 0.5, 'seed': 2045356029, 'z_wall': 1.9}
...
sequences: dict[str, str] = {
     "monoblock-pre-xl-v2": ""
}
if mode == "brush":
     ...
     sequences["monoblock-pre-xl-v2"] = f"Z{sequences['monoblock-pre-xl-v2'][1:]}"
