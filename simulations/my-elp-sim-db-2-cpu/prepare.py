...
def build_sim(sim: Sim):
     ...
     for comp in components:
          for idx in range(comp.nmol):
               ...
               pos = comp.xinit + x_c + get_clockwise_position(i) * 3.161
               sim.pos[ibead:j] = pos
               ibead = j
               i += 1
...
sequences: dict[str, str] = {
     "my-elp-sim-db-2-cpu": "VPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGKGVPGIGVPGIGVPGIGVPGIGVPGIGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGKGVPGIGVPGIGVPGIGVPGIGVPGIG"
}
sequences["my-elp-sim-db-2-cpu"] = f"Z{sequences['my-elp-sim-db-2-cpu'][1:]}"
