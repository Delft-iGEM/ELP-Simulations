...
def build_sim(sim: Sim):
     ...
     nx, ny = 4, 3
     # spacing = 0.8 x the chain's own contour length (60.42 nm for these 160 residues)
     spacing = 48.336
...
sequences: dict[str, str] = {
     "does-concentrating-work": "VPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGKGVPGIGVPGIGVPGIGVPGIGVPGIGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGKGVPGIGVPGIGVPGIGVPGIGVPGIG"
}
sequences["does-concentrating-work"] = f"Z{sequences['does-concentrating-work'][1:]}"
