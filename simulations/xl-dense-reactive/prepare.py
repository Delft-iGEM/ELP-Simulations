...
# Grafting lattice: 3 x 3 points, one chain per spacing x spacing
...
crosslink = {'distance': 0.8, 'valence': 1, 'prob': 1.0, 'check_every': 100, 'k': 2000.0, 'r0': 0.6, 'ramp_steps': 500, 'selection': None, 'start_step': 0, 'seed': None}
...
sequences: dict[str, str] = {
     "xl-dense-reactive": "VPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKG"
}
sequences["xl-dense-reactive"] = f"Z{sequences['xl-dense-reactive'][1:]}"
