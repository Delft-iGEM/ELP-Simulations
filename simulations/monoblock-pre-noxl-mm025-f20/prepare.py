...
nx, ny = 4, 4
# spacing = 1/sqrt(0.025 chains/nm^2)
spacing = 6.325
...
mode = "preattached"
surface = {'mode': 'preattached', 'distance': 0.8, 'prob': 1.0, 'max_fraction': 0.5, 'preattached_fraction': 0.2, 'dynamic': None, 'k': 2000.0, 'tether': 0.6, 'ramp_steps': 500, 'check_every': 1000, 'start_step': 1000000, 'attraction': 0.0, 'attraction_width': 0.5, 'seed': 377551878, 'z_wall': 1.9}
...
sequences: dict[str, str] = {
     "monoblock-pre-noxl-mm025-f20": ""
}
if mode == "brush":
     ...
     sequences["monoblock-pre-noxl-mm025-f20"] = f"Z{sequences['monoblock-pre-noxl-mm025-f20'][1:]}"
