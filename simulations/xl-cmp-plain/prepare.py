...
sequences: dict[str, str] = {
     "xl-cmp-plain": "VPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKGVPGVGVPGVGVPGVGVPGVGVPGKG"
}
sequences["xl-cmp-plain"] = f"Z{sequences['xl-cmp-plain'][1:]}"
