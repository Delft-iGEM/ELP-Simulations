...
def build_sim(sim: Sim):
     ...
     for comp in components:
          for idx in range(comp.nmol):
               ...
               pos = comp.xinit + x_c + get_clockwise_position(i) * 7.071
               sim.pos[ibead:j] = pos
               ibead = j
               i += 1
...
sequences: dict[str, str] = {
     "my-elp-sim-k-3-cpu": "VPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGKGVPGIGVPGIGVPGIGVPGIGVPGIGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGKGVPGIGVPGIGVPGIGVPGIGVPGIG"
}
sequences["my-elp-sim-k-3-cpu"] = f"Z{sequences['my-elp-sim-k-3-cpu'][1:]}"
