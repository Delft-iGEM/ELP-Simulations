"""ELP4-20 in free solution — a validation run, not a brush run.

One chain of G(VPGVG)20FC in a cubic box of water-as-continuum, to compare the
...
sequence = "GVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGVPGVGFC"          # G(VPGVG)20FC — 103 residues, 8.5 kDa
box_side = 20.0                 # nm, cubic
N_save = 7000
N_frames = 1429
seed = 20260943
